...
const brandCosmetics = [
  { name: 'L\'Oréal Foundation', image: cosmeticImage, route: '/products/loreal-foundation' },
  { name: 'Maybelline Lipstick', image: cosmeticImage, route: '/products/maybelline-lipstick' },
    ...
    <div>
      ...
      <div className="pt-24 px-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-[#000000]">Top Cosmetic Brands</h1>
