...
// Women's Trackpants product data with trackpant-specific attributes
const womensTrackpantsItems = [
  {
    id: 1,
    name: 'High-Waist Jogger Trackpants',
    originalPrice: 2500,
    discountedPrice: 2000,
    image: 'https://via.placeholder.com/400/8B4513/FFFFFF?text=Jogger+Trackpants',
    description: 'Comfortable high-waist jogger trackpants, perfect for workouts or casual wear.',
    rating: 4.7,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Trackpants",
    subCategory: 'Casual Trackpants',
    sizes: ['S', 'M', 'L', 'XL'],
    brand: 'Nike',
    fabric: 'Cotton Blend',
    waistType: 'High Rise',
  ...
  {
    id: 2,
    name: 'Slim Fit Lounge Trackpants',
    originalPrice: 2200,
    discountedPrice: 1760,
    image: 'https://via.placeholder.com/400/5F9EA0/FFFFFF?text=Lounge+Trackpants',
    description: 'Soft slim-fit trackpants ideal for lounging at home or light activities.',
    rating: 4.5,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Trackpants",
  ...
  {
    id: 3,
    name: 'Striped Side Detail Trackpants',
    originalPrice: 2800,
    discountedPrice: 2240,
    image: 'https://via.placeholder.com/400/FFD700/000000?text=Striped+Trackpants',
    description: 'Trendy trackpants with contrast side stripes, suitable for a sporty-chic look.',
    rating: 4.6,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Trackpants",
    subCategory: 'Fashion Trackpants',
    sizes: ['S', 'M', 'L'],
    brand: 'Puma',
    fabric: 'Polyester',
    waistType: 'Elastic',
  ...
  {
    id: 4,
    name: 'Wide Leg French Terry Trackpants',
    originalPrice: 3000,
    discountedPrice: 2400,
    image: 'https://via.placeholder.com/400/9ACD32/FFFFFF?text=Wide+Leg+Trackpants',
    description: 'Relaxed wide-leg trackpants in soft French terry, ultimate comfort.',
    rating: 4.4,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Trackpants",
  ...
  {
    id: 5,
    name: 'Camo Print Utility Trackpants',
    originalPrice: 3200,
    discountedPrice: 2560,
    image: 'https://via.placeholder.com/400/8B0000/FFFFFF?text=Camo+Trackpants',
    description: 'Stylish camo print trackpants with utility pockets, perfect for street style.',
    rating: 4.7,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Trackpants",
  ...
  {
    id: 6,
    name: 'Thermal Fleece Trackpants',
    originalPrice: 2700,
    discountedPrice: 2160,
    image: 'https://via.placeholder.com/400/4682B4/FFFFFF?text=Thermal+Trackpants',
    description: 'Warm thermal fleece trackpants, ideal for cold weather workouts or outdoor activities.',
    rating: 4.8,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Trackpants",
  ...
  {
    id: 7,
    name: 'Yoga Stretch Trackpants',
    originalPrice: 2000,
    discountedPrice: 1600,
    image: 'https://via.placeholder.com/400/DAA520/FFFFFF?text=Yoga+Trackpants',
    description: 'Super stretchy trackpants designed for yoga and pilates, offers great flexibility.',
    rating: 4.5,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Trackpants",
  ...
  {
    id: 8,
    name: 'Capri Length Trackpants',
    originalPrice: 1800,
    discountedPrice: 1440,
    image: 'https://via.placeholder.com/400/6A5ACD/FFFFFF?text=Capri+Trackpants',
    description: 'Comfortable capri length trackpants for light workouts or summer casuals.',
    rating: 4.3,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Trackpants",
...
function WomensTrackpants() {
  ...
  const brands = [...new Set(womensTrackpantsItems.map((item) => item.brand))];
  const allAvailableFabrics = [...new Set(womensTrackpantsItems.map((item) => item.fabric))];
  const allAvailableCategories = [...new Set(womensTrackpantsItems.map((item) => item.subCategory))];
  const allAvailableWaistTypes = [...new Set(womensTrackpantsItems.map((item) => item.waistType))];
  const allAvailableFits = [...new Set(womensTrackpantsItems.map((item) => item.fit))];
  const allAvailableLengths = [...new Set(womensTrackpantsItems.map((item) => item.length))];
  const allAvailableOccasions = [...new Set(womensTrackpantsItems.map((item) => item.occasion))];
  ...
  const filteredAndSortedItems = womensTrackpantsItems
    .filter((item) => {
      ...
      <div className="flex-grow pt-16">
        <div className="max-w-screen-xl mx-auto px-4 py-4 pb-12">
          ...
          <div className="text-xs text-gray-600 mb-4">
            ...
            / <span className="font-semibold">Trackpants</span> - {filteredAndSortedItems.length} Items
          </div>

          {/* Filter and Sort Controls */}
          <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
            <h2 className="text-lg font-bold text-gray-800 sm:text-sm">Trackpants ({filteredAndSortedItems.length})</h2>
...
export default WomensTrackpants;