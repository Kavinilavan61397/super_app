...
const shampooProducts = [
  {
    ...
    originalPrice: 280,
    discountedPrice: 224,
    description: 'Shampoo to strengthen hair and reduce hair fall.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Himalaya',
    category: 'Hair Fall Control Shampoo',
    variant: 'Hair Fall Control',
    inStock: true,
    image: 'https://via.placeholder.com/150/FFDAB9/FFFFFF?text=Anti-Hair+Fall+Shampoo',
    deliveryInfo: {
      returns: 'No Returns',
    ...
    offers: [
      { code: 'SHAMP5', description: '₹5 off on first order', discount: 5 },
  ...
  {
    id: 2,
    name: 'Kesh Raksha Shampoo',
    originalPrice: 250,
    discountedPrice: 200,
    description: 'Ayurvedic shampoo for healthy and strong hair.',
    rating: 4.6,
    isBestSeller: true,
    brand: 'Patanjali',
    ...
    variant: 'Normal Hair',
    inStock: true,
    image: 'https://via.placeholder.com/150/98FB98/FFFFFF?text=Kesh+Raksha+Shampoo',
    deliveryInfo: {
  ...
  {
    id: 3,
    name: 'Bio Neem Shampoo',
    originalPrice: 300,
    discountedPrice: 240,
    description: 'Anti-dandruff shampoo for a clean scalp.',
    rating: 4.4,
    isBestSeller: false,
    brand: 'Biotique',
    ...
    inStock: true,
    image: 'https://via.placeholder.com/150/ADFF2F/FFFFFF?text=Bio+Neem+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
  ...
  },
  {
    ...
    isBestSeller: true,
    brand: 'Himalaya',
    category: 'Nourishing Shampoo',
    variant: 'Dry Hair',
    inStock: true,
    image: 'https://via.placeholder.com/150/ADD8E6/FFFFFF?text=Protein+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  },
  {
    ...
    originalPrice: 220,
    discountedPrice: 176,
    description: 'Herbal shampoo for gentle cleansing.',
    rating: 4.3,
    isBestSeller: false,
    brand: 'Patanjali',
    category: 'Herbal Shampoo',
    variant: 'Oily Hair',
    inStock: true,
    image: 'https://via.placeholder.com/150/90EE90/FFFFFF?text=Shikakai+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 21st June 2025',
  ...
  },
  {
    ...
    originalPrice: 350,
    discountedPrice: 280,
    description: 'Protein-rich shampoo for hair strength.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Biotique',
    category: 'Nourishing Shampoo',
    ...
    inStock: true,
    image: 'https://via.placeholder.com/150/87CEEB/FFFFFF?text=Bio+Kelp+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  {
    id: 7,
    name: 'Gentle Daily Care Shampoo',
    originalPrice: 400,
    discountedPrice: 320,
    description: 'Mild shampoo for daily use.',
    rating: 4.6,
    isBestSeller: false,
    brand: 'Himalaya',
    category: 'Nourishing Shampoo',
    variant: 'Normal Hair',
    inStock: true,
    image: 'https://via.placeholder.com/150/E6E6FA/FFFFFF?text=Gentle+Care+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 21st June 2025',
  ...
  },
  {
    ...
    originalPrice: 200,
    discountedPrice: 160,
    description: 'Soothing shampoo for scalp health.',
    rating: 4.4,
    isBestSeller: false,
    brand: 'Patanjali',
    category: 'Herbal Shampoo',
    variant: 'Dry Hair',
    inStock: true,
    image: 'https://via.placeholder.com/150/20B2AA/FFFFFF?text=Aloe+Vera+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 21st June 2025',
  ...
  {
    id: 9,
    name: 'Bio Margosa Shampoo',
    originalPrice: 330,
    discountedPrice: 264,
    description: 'Anti-dandruff shampoo for itch-free scalp.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Biotique',
    category: 'Anti-Dandruff Shampoo',
    variant: 'Dandruff Control',
    inStock: true,
    image: 'https://via.placeholder.com/150/F4A460/FFFFFF?text=Bio+Margosa+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  },
  {
    ...
    originalPrice: 360,
    discountedPrice: 288,
    description: 'Shampoo to repair damaged hair.',
    rating: 4.7,
    isBestSeller: true,
    brand: 'Himalaya',
    category: 'Nourishing Shampoo',
    variant: 'Damaged Hair',
    inStock: false,
    image: 'https://via.placeholder.com/150/FFDEAD/FFFFFF?text=Damage+Repair+Shampoo',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
...
const ShampooHeader = ({ setSelectedCategory, selectedCategory }) => {
  const [isShampooSubmenuOpen, setIsShampooSubmenuOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const shampooCategories = [
    { name: 'All', value: 'all' },
    { name: 'Nourishing Shampoo', value: 'Nourishing Shampoo' },
    { name: 'Anti-Dandruff Shampoo', value: 'Anti-Dandruff Shampoo' },
    { name: 'Herbal Shampoo', value: 'Herbal Shampoo' },
    { name: 'Hair Fall Control Shampoo', value: 'Hair Fall Control Shampoo' },
  ];
  ...
  const toggleShampooSubmenu = () => {
    setIsShampooSubmenuOpen((prev) => !prev);
  };
    ...
    <header className="bg-black text-white p-4 fixed top-0 left-0 w-full z-10 min-h-[60px]">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        <div className="flex items-center justify-between w-full sm:w-auto">
          <h1 className="text-xl font-bold">Shampoo Collection</h1>
          {/* <button
        ...
        <nav className={`flex flex-col sm:flex-row items-center gap-2 sm:gap-4 ${isMobileMenuOpen ? 'block' : 'hidden sm:flex'}`}>
          <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full">
            {shampooCategories.map((category) => (
              <li key={category.value} className="relative">
                {category.name === 'Nourishing Shampoo' ? (
                  <>
                    <button
                      className={`text-sm px-3 py-1 rounded-md ${
                        selectedCategory === category.value || shampooVariants.includes(selectedCategory)
                          ? 'bg-white text-black'
                          : 'bg-black text-white hover:bg-gray-700'
                      }`}
                      onClick={toggleShampooSubmenu}
                      aria-label={`Toggle ${category.name} submenu`}
                    >
                      {category.name}
                      <svg
                        className={`inline-block ml-1 w-4 h-4 transform ${isShampooSubmenuOpen ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
...
const ShampooCard = ({ item, onQuickView, addToCart, addToWishlist, cartItems, wishlistItems }) => {
    ...
    <div className="group bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 flex flex-col h-full">
      <div className="relative flex-shrink-0 bg-white">
        <img
          ...
          loading="lazy"
          onClick={() => navigate(`/shampoos/product/${item.id}`)}
        />
...
const ProductDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const product = shampooProducts.find((p) => p.id === parseInt(id));
...
function Shampoos() {
      ...
      .filter((product) => {
        ...
        const matchesCategory =
          selectedCategory === 'all'
            ? true
            : shampooCategories.includes(selectedCategory)
            ? product.category === selectedCategory
            : shampooVariants.includes(selectedCategory)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      <ShampooHeader setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
            ...
            <div className="flex-grow pt-20">
              <div className="max-w-screen-xl mx-auto px-4 py-4 pb-16 relative">
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  <span className="font-semibold">Shampoos</span> - {filteredAndSortedItems.length} Items
                </div>

                <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
                  <h2 className="text-xl font-bold text-gray-800 sm:text-sm">Shampoos ({filteredAndSortedItems.length} Items)</h2>
                ...
                <main className="flex-grow">
                  ...
                  {filteredAndSortedItems.length === 0 && (
                    <p className="text-center text-gray-600 mt-8 text-sm">No shampoos found matching your criteria.</p>
                  )}
                </main>
              </div>
            </div>
