...
// Palazzo pants product data with palazzo-specific attributes
const palazzoItems = [
  {
    id: 1,
    name: 'High-Waist Silk Palazzo Pants',
    originalPrice: 4500,
    discountedPrice: 3600,
    image: 'https://via.placeholder.com/400/8B0000/FFFFFF?text=Silk+Palazzo',
    description: 'Elegant high-waist silk palazzo pants with a flowy fit, perfect for formal occasions.',
    rating: 4.8,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Formal Palazzo',
    brand: 'Fabindia',
    material: 'Silk',
    fit: 'Regular',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400/008B8B/FFFFFF?text=Cotton+Palazzo',
    description: 'Comfortable cotton palazzo pants with vibrant prints, ideal for casual wear.',
    rating: 4.5,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Casual Palazzo',
    brand: 'Biba',
    material: 'Cotton',
    fit: 'Relaxed',
    waistType: 'Mid-Waist',
  ...
  {
    id: 3,
    name: 'Chiffon Embroidered Palazzo Pants',
    originalPrice: 3500,
    discountedPrice: 2800,
    image: 'https://via.placeholder.com/400/4B0082/FFFFFF?text=Chiffon+Palazzo',
    description: 'Chiffon palazzo pants with intricate embroidery, perfect for festive events.',
    rating: 4.9,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Festive Palazzo',
    brand: 'Manyavar',
    material: 'Chiffon',
    fit: 'Flared',
    waistType: 'High-Waist',
  ...
  {
    id: 4,
    name: 'Rayon Straight Palazzo Pants',
    originalPrice: 2500,
    discountedPrice: 2000,
    image: 'https://via.placeholder.com/400/800080/FFFFFF?text=Rayon+Palazzo',
    description: 'Soft rayon palazzo pants with a straight fit, suitable for daily wear.',
    rating: 4.6,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Daily Wear Palazzo',
    brand: 'W for Women',
    material: 'Rayon',
    fit: 'Straight',
    waistType: 'Mid-Waist',
  ...
  {
    id: 5,
    name: 'Linen Wide-Leg Palazzo Pants',
    originalPrice: 3000,
    discountedPrice: 2400,
    image: 'https://via.placeholder.com/400/228B22/FFFFFF?text=Linen+Palazzo',
    description: 'Breathable linen palazzo pants with a wide-leg fit, ideal for summer.',
    rating: 4.7,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
  ...
  {
    id: 6,
    name: 'Georgette Sequined Palazzo Pants',
    originalPrice: 4000,
    discountedPrice: 3200,
    image: 'https://via.placeholder.com/400/FFD700/FFFFFF?text=Georgette+Palazzo',
    description: 'Glamorous georgette palazzo pants with sequin embellishments, perfect for parties.',
    rating: 4.7,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Party Wear Palazzo',
    brand: 'BharatSthali',
    material: 'Georgette',
    fit: 'Flared',
    waistType: 'High-Waist',
  ...
  {
    id: 7,
    name: 'Viscose Pleated Palazzo Pants',
    originalPrice: 2800,
    discountedPrice: 2240,
    image: 'https://via.placeholder.com/400/DAA520/FFFFFF?text=Viscose+Palazzo',
    description: 'Viscose palazzo pants with pleated design, great for semi-formal occasions.',
    rating: 4.4,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
    subCategory: 'Semi-Formal Palazzo',
    brand: 'Global Desi',
    material: 'Viscose',
    fit: 'Regular',
    waistType: 'Mid-Waist',
  ...
  {
    id: 8,
    name: 'Polyester Striped Palazzo Pants',
    originalPrice: 2200,
    discountedPrice: 1760,
    image: 'https://via.placeholder.com/400/D2691E/FFFFFF?text=Polyester+Palazzo',
    description: 'Stylish polyester palazzo pants with striped pattern, perfect for casual outings.',
    rating: 4.3,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - Palazzo Pants",
...
function PalazzoPants() {
  ...
  const brands = [...new Set(palazzoItems.map((item) => item.brand))];
  const allAvailableMaterials = [...new Set(palazzoItems.map((item) => item.material))];
  const allAvailableCategories = [...new Set(palazzoItems.map((item) => item.subCategory))];
  const allAvailableFits = [...new Set(palazzoItems.map((item) => item.fit))];
  const allAvailableWaistTypes = [...new Set(palazzoItems.map((item) => item.waistType))];
  const allAvailableOccasions = [...new Set(palazzoItems.map((item) => item.occasion))];
      ...
      <div className="flex-grow pt-16">
        <div className="max-w-screen-xl mx-auto px-4 py-4 pb-12">
          ...
          <div className="text-xs text-gray-600 mb-4">
            ...
            / <span className="font-semibold">Palazzo Pants</span> - {filteredAndSortedItems.length} Items
          </div>

          {/* Filter and Sort Controls */}
          <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
            <h2 className="text-lg font-bold text-gray-800 sm:text-sm">Palazzo Pants ({filteredAndSortedItems.length})</h2>
