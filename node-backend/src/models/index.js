...
// Category ↔ Product (and self-reference)
...
Product.belongsTo(Category, { as: 'productCategory', foreignKey: 'category_id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });

// Product ↔ Brand association is defined in Product.js
...
ProductAttribute.belongsTo(Product, { foreignKey: 'product_id', as: 'productAttributeProduct', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
