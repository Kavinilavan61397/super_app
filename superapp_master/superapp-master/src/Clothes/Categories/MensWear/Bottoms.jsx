      ...
      <div className="flex-grow pt-20"> 
        <div className="max-w-screen-xl mx-auto px-4 py-4 pb-32"> 
          ...
          <div className="text-sm text-gray-600 mb-4">
            <Link to="/home-clothes" className="hover:underline">Home</Link> / <Link to="/home-clothes/categories" className="hover:underline">Categories</Link> / <Link to="/categories/mens-wear" className="hover:underline">Men's Wear</Link> / <span className="font-semibold">Bottoms</span> - {filteredAndSortedItems.length} Items
          </div>

          {/* Title Section */}
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Men's Bottoms Collection</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our diverse range of men's bottoms, from classic jeans to formal trousers. 
              Find the perfect fit and style for every occasion in our curated collection.
            </p>
          </div>
          ...
          <div className="flex justify-end items-center mb-4 relative">
            ...
            {showFilters && (
              <div
                ref={filterPanelRef}
                className="absolute z-30 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-2 sm:p-6 max-h-[80vh] overflow-y-auto
                  w-full max-w-xs left-1/2 -translate-x-1/2 sm:w-96 sm:max-w-none sm:left-auto sm:right-0 sm:translate-x-0"
                style={{ top: '100%' }}
              >
                ...
                {/* Topic Filter */}
                <div className="mb-2 sm:mb-6">
                  <h3 className="text-sm sm:text-md font-semibold text-gray-700 mb-1 sm:mb-3">Bottom Type</h3>
                  <div className="flex flex-wrap gap-1 sm:gap-2">
                    {allTopics.map(topic => (
                      <button
                        key={topic}
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 mb-2">Bottoms</p>
