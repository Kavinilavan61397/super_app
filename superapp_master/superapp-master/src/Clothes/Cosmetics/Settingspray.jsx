...
// Setting Spray Data for Indian Brands
const settingSprayProducts = [
  {
    id: 1,
    name: "Swiss Beauty Long Lasting Misty Finish Spray",
    originalPrice: 349,
    discountedPrice: 205,
    description: "A lightweight matte finish spray with Aloe Vera and Vitamin E for hydration.",
    rating: 4.5,
    isBestSeller: true,
    brand: "Swiss Beauty",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/FFDAB9/FFFFFF?text=Swiss+Beauty+Matte",
    deliveryInfo: {
    ...
    offers: [
      { code: "SPRAY5", description: "₹50 off on first order", discount: 50 },
      { code: "FREESHIP", description: "Free delivery on orders above ₹2000", discount: "Free Shipping" },
    ],
  },
  {
    id: 2,
    name: "Nykaa Matte to Last Setting Spray",
    originalPrice: 799,
    discountedPrice: 639,
    description: "A long-lasting matte spray for a flawless, oil-free look.",
    rating: 4.6,
    isBestSeller: true,
    brand: "Nykaa",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/98FB98/FFFFFF?text=Nykaa+Matte",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 3,
    name: "Lakmé Absolute Made to Last Setting Spray",
    originalPrice: 450,
    discountedPrice: 360,
    description: "A lightweight spray for a natural, long-lasting makeup finish.",
    rating: 4.4,
    isBestSeller: false,
    brand: "Lakmé",
    ...
    finish: "Natural",
    inStock: true,
    image: "https://via.placeholder.com/150/ADFF2F/FFFFFF?text=Lakmé+Natural",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
  ...
  {
    id: 4,
    name: "SUGAR Grand Finale Setting Mist",
    originalPrice: 599,
    discountedPrice: 479,
    description: "An alcohol-free mist with SPF 30 for a smudge-free look.",
    rating: 4.7,
    isBestSeller: true,
    ...
    finish: "Dewy",
    inStock: true,
    image: "https://via.placeholder.com/150/ADD8E6/FFFFFF?text=SUGAR+Dewy",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 5,
    name: "RENEE Makeup Fixer Setting Spray",
    originalPrice: 399,
    discountedPrice: 319,
    description: "A hydrating spray with Aloe Vera and Niacinamide for nourishment.",
    rating: 4.6,
    isBestSeller: false,
    brand: "RENEE",
    category: "Hydrating",
    finish: "Dewy",
    inStock: true,
    image: "https://via.placeholder.com/150/90EE90/FFFFFF?text=RENEE+Dewy",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 6,
    name: "Nykaa Luxe Radiant Finish Spray",
    originalPrice: 999,
    discountedPrice: 799,
    description: "A radiant spray for a glowing, long-lasting makeup look.",
    rating: 4.5,
    isBestSeller: true,
    brand: "Nykaa",
    ...
    finish: "Luminous",
    inStock: true,
    image: "https://via.placeholder.com/150/87CEEB/FFFFFF?text=Nykaa+Luminous",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 7,
    name: "Swiss Beauty Natural Makeup Fixer",
    originalPrice: 349,
    discountedPrice: 279,
    description: "A natural finish spray to lock makeup without stickiness.",
    rating: 4.4,
    isBestSeller: false,
    brand: "Swiss Beauty",
    category: "Long-Lasting",
    finish: "Natural",
    inStock: true,
    image: "https://via.placeholder.com/150/E6E6FA/FFFFFF?text=Swiss+Natural",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 8,
    name: "Lakmé Vitamin C Superglow Fixer",
    originalPrice: 499,
    discountedPrice: 399,
    description: "A spray with Vitamin C for a radiant, hydrated finish.",
    rating: 4.5,
    isBestSeller: true,
    brand: "Lakmé",
    category: "Illuminating",
    finish: "Luminous",
    inStock: true,
    image: "https://via.placeholder.com/150/20B2AA/FFFFFF?text=Lakmé+Luminous",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 9,
    name: "SUGAR Matte Finish Setting Mist",
    originalPrice: 649,
    discountedPrice: 519,
    description: "A matte spray for oil control and long-lasting makeup.",
    rating: 4.6,
    isBestSeller: false,
    brand: "SUGAR Cosmetics",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/F4A460/FFFFFF?text=SUGAR+Matte",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 10,
    name: "RENEE Long-Lasting Matte Spray",
    originalPrice: 499,
    discountedPrice: 399,
    description: "A matte spray for a smudge-free, oil-controlled look.",
    rating: 4.4,
    isBestSeller: false,
    brand: "RENEE",
    category: "Matte",
    finish: "Matte",
    inStock: false,
    image: "https://via.placeholder.com/150/FFDEAD/FFFFFF?text=RENEE+Matte",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
...
const SettingSprayHeader = ({ setSelectedCategory, selectedCategory }) => {
  const [isSettingSpraySubmenuOpen, setIsSettingSpraySubmenuOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const settingSprayCategories = [
    { name: "All", value: "all" },
    { name: "Hydrating", value: "Hydrating" },
    { name: "Matte", value: "Matte" },
    { name: "Long-Lasting", value: "Long-Lasting" },
    { name: "Illuminating", value: "Illuminating" },
  ];

  const settingSprayFinishes = ["Dewy", "Matte", "Natural", "Luminous"];

  const toggleSettingSpraySubmenu = () => {
    setIsSettingSpraySubmenuOpen((prev) => !prev);
  };
  ...
  const handleCategoryClick = (category) => {
    ...
    setIsSettingSpraySubmenuOpen(false);
      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <nav className={`flex flex-col sm:flex-row items-center gap-2 sm:gap-4 ${isMobileMenuOpen ? "block" : "hidden sm:flex"}`}>
          <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full">
            {settingSprayCategories.map((category) => (
              <li key={category.value} className="relative">
                {category.name === "Hydrating" ? (
                  <>
                    <button
                      className={`text-sm px-3 py-1 rounded-md ${
                        selectedCategory === category.value || settingSprayFinishes.includes(selectedCategory)
                          ? "bg-white text-black"
                          : "bg-black text-white hover:bg-gray-700"
                      }`}
                      onClick={toggleSettingSpraySubmenu}
                      aria-label={`Toggle ${category.name} submenu`}
                    >
                      {category.name}
                      <FaChevronDown className={`inline-block ml-1 w-4 h-4 transform ${isSettingSpraySubmenuOpen ? "rotate-180" : ""}`} />
                    </button>
                    {isSettingSpraySubmenuOpen && (
                      <div className="absolute top-8 left-0 bg-white text-black border border-gray-300 rounded-md shadow-lg z-50 w-48">
                        ...
                        <ul>
                          {settingSprayFinishes.map((finish) => (
                            <li key={finish}>
                              <button
...
const SettingSprayCard = ({ item, onQuickView, addToCart, addToWishlist, cartItems, wishlistItems }) => {
...
const ProductDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const product = settingSprayProducts.find((p) => p.id === parseInt(id));
...
function SettingSprays() {
  ...
  const brands = ["Swiss Beauty", "Nykaa", "Lakmé", "SUGAR Cosmetics", "RENEE"];
  const priceRanges = [
  ...
  const settingSprayCategories = ["Hydrating", "Matte", "Long-Lasting", "Illuminating"];
  const settingSprayFinishes = ["Dewy", "Matte", "Natural", "Luminous"];
  const sortOptions = [
      ...
      .filter((product) => {
        ...
        const matchesCategory =
          selectedCategory === "all"
            ? true
            : settingSprayCategories.includes(selectedCategory)
            ? product.category === selectedCategory
            : settingSprayFinishes.includes(selectedCategory)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      <SettingSprayHeader setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
            ...
            <div className="flex-grow pt-20">
              <div className="max-w-screen-xl mx-auto px-4 py-4 pb-16 relative">
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  / <span className="font-semibold">Setting Sprays</span> - {filteredAndSortedItems.length} Items
                </div>
                ...
                <main className="flex-grow">
                  ...
                  {filteredAndSortedItems.length === 0 && (
                    <p className="text-center text-gray-600 mt-8 text-sm">No setting sprays found matching your criteria.</p>
                  )}
                </main>
              </div>
            </div>
