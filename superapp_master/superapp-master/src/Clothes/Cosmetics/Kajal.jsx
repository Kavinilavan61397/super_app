...
const kajalProducts = [
  {
    ...
    originalPrice: 200,
    discountedPrice: 180,
    description: 'Long-lasting, smudge-proof kajal for intense black eyes.',
    rating: 4.6,
    isBestSeller: true,
    brand: 'Lakmé',
    ...
    color: 'Black',
    inStock: true,
    image: 'https://via.placeholder.com/150/000000/FFFFFF?text=Eyeconic+Kajal',
    deliveryInfo: {
      returns: 'No Returns',
    ...
    offers: [
      { code: 'KAJAL5', description: '₹5 off on first order', discount: 5 },
  ...
  },
  {
    ...
    originalPrice: 300,
    discountedPrice: 270,
    description: 'Waterproof kajal with intense color payoff.',
    rating: 4.5,
    isBestSeller: true,
    ...
    color: 'Black',
    inStock: true,
    image: 'https://via.placeholder.com/150/1C2526/FFFFFF?text=Colossal+Kajal',
    deliveryInfo: {
  ...
  },
  {
    ...
    originalPrice: 150,
    discountedPrice: 135,
    description: 'Natural kajal enriched with almond oil for sensitive eyes.',
    rating: 4.3,
    isBestSeller: false,
    brand: 'Lotus Herbals',
    category: 'Natural',
    color: 'Black',
    inStock: true,
    image: 'https://via.placeholder.com/150/2F4F4F/FFFFFF?text=Herbal+Kajal',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
  ...
  {
    id: 4,
    name: 'Signature Kajal',
    originalPrice: 120,
    discountedPrice: 100,
    description: 'Affordable smudge-proof kajal for daily use.',
    rating: 4.2,
    isBestSeller: true,
    brand: 'Blue Heaven',
    category: 'Smudge-Proof',
    color: 'Navy Blue',
    inStock: true,
    image: 'https://via.placeholder.com/150/000080/FFFFFF?text=Signature+Kajal',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  {
    id: 5,
    name: 'Ace of Face Kajal',
    originalPrice: 450,
    discountedPrice: 400,
    description: 'Gel-based kajal for bold and precise application.',
    rating: 4.7,
    isBestSeller: true,
    ...
    color: 'Black',
    inStock: true,
    image: 'https://via.placeholder.com/150/4A4A4A/FFFFFF?text=Ace+of+Face+Kajal',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  {
    id: 6,
    name: 'Ultime Pro Kajal',
    originalPrice: 250,
    discountedPrice: 225,
    description: 'Waterproof kajal with vibrant color options.',
    rating: 4.4,
    isBestSeller: false,
    brand: 'Faces Canada',
    category: 'Waterproof',
    color: 'Green',
    inStock: true,
    image: 'https://via.placeholder.com/150/006400/FFFFFF?text=Ultime+Pro+Kajal',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 21st June 2025',
  ...
  },
  {
    ...
    originalPrice: 100,
    discountedPrice: 90,
    description: 'Budget-friendly kajal for a bold look.',
    rating: 4.3,
    isBestSeller: true,
    brand: 'Elle 18',
    category: 'Smudge-Proof',
    color: 'Black',
    inStock: true,
    image: 'https://via.placeholder.com/150/333333/FFFFFF?text=Kajal+Magique',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 20th June 2025',
  ...
  },
  {
    ...
    originalPrice: 180,
    discountedPrice: 160,
    description: 'Herbal kajal with soothing ingredients for daily wear.',
    rating: 4.2,
    isBestSeller: false,
    brand: 'Himalaya',
    category: 'Natural',
    color: 'Black',
    inStock: false,
    image: 'https://via.placeholder.com/150/696969/FFFFFF?text=Natural+Kajal',
    deliveryInfo: {
      returns: '30-day Returns',
      paymentOptions: 'Cash on Delivery, UPI, Credit/Debit Card',
      deliveryDate: 'By 21st June 2025',
...
const KajalHeader = ({ setSelectedCategory, selectedCategory }) => {
  const [isKajalSubmenuOpen, setIsKajalSubmenuOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const kajalCategories = [
    { name: 'All', value: 'all' },
    { name: 'Waterproof', value: 'Waterproof' },
    { name: 'Smudge-Proof', value: 'Smudge-Proof' },
    { name: 'Gel', value: 'Gel' },
    { name: 'Natural', value: 'Natural' },
  ];

  const kajalColors = ['Black', 'Navy Blue', 'Green'];

  const toggleKajalSubmenu = () => {
    setIsKajalSubmenuOpen((prev) => !prev);
  };
      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <nav className={`flex flex-col sm:flex-row items-center gap-2 sm:gap-4 ${isMobileMenuOpen ? 'block' : 'hidden sm:flex'}`}>
          <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full">
            {kajalCategories.map((category) => (
              <li key={category.value} className="relative">
                {category.name === 'Waterproof' ? (
                  <>
                    <button
                      className={`text-sm px-3 py-1 rounded-md ${
                        selectedCategory === category.value || kajalColors.includes(selectedCategory)
                          ? 'bg-white text-black'
                          : 'bg-black text-white hover:bg-gray-700'
                      }`}
                      onClick={toggleKajalSubmenu}
                      aria-label={`Toggle ${category.name} submenu`}
                    >
                      {category.name}
                      <svg
                        className={`inline-block ml-1 w-4 h-4 transform ${isKajalSubmenuOpen ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
...
const KajalCard = ({ item, onQuickView, addToCart, addToWishlist, cartItems, wishlistItems }) => {
...
const ProductDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const product = kajalProducts.find((p) => p.id === parseInt(id));
  const kajalColors = ['Black', 'Navy Blue', 'Green'];
...
function Kajals() {
  ...
  const brands = ['Lakmé', 'Maybelline India', 'Lotus Herbals', 'Blue Heaven', 'Sugar Cosmetics', 'Faces Canada', 'Elle 18', 'Himalaya'];
  const priceRanges = [
  ...
  const kajalSubcategories = ['Waterproof', 'Smudge-Proof', 'Gel', 'Natural'];
  const kajalColors = ['Black', 'Navy Blue', 'Green'];
  const sortOptions = [
      ...
      .filter((product) => {
        ...
        const matchesCategory =
          selectedCategory === 'all'
            ? true
            : kajalSubcategories.includes(selectedCategory)
            ? product.category === selectedCategory
            : kajalColors.includes(selectedCategory)
      ...
      case 'categories':
        return (
          <div className="space-y-2">
            {kajalSubcategories.map((category) => (
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      <KajalHeader setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
            ...
            <div className="flex-grow pt-20">
              <div className="max-w-screen-xl mx-auto px-4 py-4 pb-16 relative">
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  <span className="font-semibold">Kajals</span> - {filteredAndSortedItems.length} Items
                </div>

                <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
                  <h2 className="text-xl font-bold text-gray-800 sm:text-sm">Kajals ({filteredAndSortedItems.length} Items)</h2>
                ...
                <main className="flex-grow">
                  ...
                  {filteredAndSortedItems.length === 0 && (
                    <p className="text-center text-gray-600 mt-8 text-sm">No kajals found matching your criteria.</p>
                  )}
                </main>
              </div>
            </div>
