...
const eyeshadowProducts = [
  {
    id: 1,
    name: "Matte Rose Palette",
    originalPrice: 1200,
    discountedPrice: 960,
    description: "A versatile matte palette with rose-toned shades.",
    rating: 4.6,
    isBestSeller: true,
    brand: "ColorPop",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/FFDAB9/FFFFFF?text=Matte+Rose+Palette",
    deliveryInfo: {
    ...
    offers: [
      { code: "EYE5", description: "₹50 off on first order", discount: 50 },
  ...
  {
    id: 2,
    name: "Shimmer Glow Palette",
    originalPrice: 1500,
    discountedPrice: 1200,
    description: "A vibrant shimmery palette with neutral tones.",
    rating: 4.5,
    isBestSeller: true,
    brand: "LuxeBeauty",
    category: "Shimmer",
    finish: "Shimmer",
    inStock: true,
    image: "https://via.placeholder.com/150/98FB98/FFFFFF?text=Shimmer+Glow+Palette",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 3,
    name: "Smokey Matte Single",
    originalPrice: 800,
    discountedPrice: 640,
    description: "A bold matte single shadow in deep smokey tones.",
    rating: 4.4,
    isBestSeller: false,
    brand: "GlamVibe",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/ADFF2F/FFFFFF?text=Smokey+Matte+Single",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
  ...
  {
    id: 4,
    name: "Glitter Star Palette",
    originalPrice: 1800,
    discountedPrice: 1440,
    description: "A sparkling glitter palette for bold looks.",
    rating: 4.7,
    isBestSeller: true,
    brand: "ColorPop",
    category: "Glitter",
    finish: "Glitter",
    inStock: true,
    image: "https://v ia.placeholder.com/150/ADD8E6/FFFFFF?text=Glitter+Star+Palette",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 5,
    name: "Neutral Satin Single",
    originalPrice: 600,
    discountedPrice: 480,
    description: "A smooth satin single shadow for everyday wear.",
    rating: 4.3,
    isBestSeller: false,
    brand: "LuxeBeauty",
    category: "Satin",
    finish: "Satin",
    inStock: true,
    image: "https://via.placeholder.com/150/90EE90/FFFFFF?text=Neutral+Satin+Single",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 6,
    name: "Vivid Shimmer Palette",
    originalPrice: 2000,
    discountedPrice: 1600,
    description: "A vibrant shimmery palette with bold colors.",
    rating: 4.5,
    isBestSeller: true,
    brand: "GlamVibe",
    category: "Shimmer",
    finish: "Shimmer",
    inStock: true,
    image: "https://via.placeholder.com/150/87CEEB/FFFFFF?text=Vivid+Shimmer+Palette",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 7,
    name: "Earthy Matte Palette",
    originalPrice: 1700,
    discountedPrice: 1360,
    description: "A matte palette with earthy, natural tones.",
    rating: 4.6,
    isBestSeller: false,
    brand: "ColorPop",
    category: "Matte",
    finish: "Matte",
    inStock: true,
    image: "https://via.placeholder.com/150/E6E6FA/FFFFFF?text=Earthy+Matte+Palette",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 8,
    name: "Pearl Glow Single",
    originalPrice: 700,
    discountedPrice: 560,
    description: "A pearlescent single shadow for a subtle glow.",
    rating: 4.4,
    isBestSeller: false,
    brand: "LuxeBeauty",
    category: "Satin",
    finish: "Satin",
    inStock: true,
    image: "https://via.placeholder.com/150/20B2AA/FFFFFF?text=Pearl+Glow+Single",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 21st June 2025",
  ...
  {
    id: 9,
    name: "Bold Glitter Single",
    originalPrice: 900,
    discountedPrice: 720,
    description: "A striking glitter single shadow for dramatic looks.",
    rating: 4.5,
    isBestSeller: true,
    brand: "GlamVibe",
    category: "Glitter",
    finish: "Glitter",
    inStock: true,
    image: "https://via.placeholder.com/150/F4A460/FFFFFF?text=Bold+Glitter+Single",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
  ...
  {
    id: 10,
    name: "Sunset Matte Palette",
    originalPrice: 2200,
    discountedPrice: 1760,
    description: "A matte palette with warm sunset-inspired tones.",
    rating: 4.7,
    isBestSeller: true,
    brand: "ColorPop",
    category: "Matte",
    finish: "Matte",
    inStock: false,
    image: "https://via.placeholder.com/150/FFDEAD/FFFFFF?text=Sunset+Matte+Palette",
    deliveryInfo: {
      returns: "7-day Returns",
      paymentOptions: "Cash on Delivery, UPI, Credit/Debit Card",
      deliveryDate: "By 20th June 2025",
...
const EyeshadowHeader = ({ setSelectedCategory, selectedCategory }) => {
  const [isEyeshadowSubmenuOpen, setIsEyeshadowSubmenuOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const eyeshadowCategories = [
    { name: "All", value: "all" },
  ...
  const eyeshadowFinishes = ["Matte", "Shimmer", "Satin", "Glitter"];

  const toggleEyeshadowSubmenu = () => {
    setIsEyeshadowSubmenuOpen((prev) => !prev);
  };
  ...
  const handleCategoryClick = (category) => {
    ...
    setIsEyeshadowSubmenuOpen(false);
    ...
    <header className="bg-black text-white p-4 fixed top-0 left-0 w-full z-10 min-h-[60px]">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        <div className="flex items-center justify-between w-full sm:w-auto">
          <h1 className="text-xl font-bold">Women's Eyeshadow Collection</h1>
        </div>
        <nav className={`flex flex-col sm:flex-row items-center gap-2 sm:gap-4 ${isMobileMenuOpen ? "block" : "hidden sm:flex"}`}>
          <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full">
            {eyeshadowCategories.map((category) => (
              <li key={category.value} className="relative">
                {category.name === "Matte" ? (
                  <>
                    <button
                      className={`text-sm px-3 py-1 rounded-md ${
                        selectedCategory === category.value || eyeshadowFinishes.includes(selectedCategory)
                          ? "bg-white text-black"
                          : "bg-black text-white hover:bg-gray-700"
                      }`}
                      onClick={toggleEyeshadowSubmenu}
                      aria-label={`Toggle ${category.name} submenu`}
                    >
                      {category.name}
                      <svg
                        className={`inline-block ml-1 w-4 h-4 transform ${isEyeshadowSubmenuOpen ? "rotate-180" : ""}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
...
const EyeshadowCard = ({ item, onQuickView, addToCart, addToWishlist, cartItems, wishlistItems }) => {
    ...
    <div className="group bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 flex flex-col h-full">
      <div className="relative flex-shrink-0 bg-white">
        <img
          ...
          loading="lazy"
          onClick={() => navigate(`/eyeshadows/product/${item.id}`)}
        />
...
const ProductDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const product = eyeshadowProducts.find((p) => p.id === parseInt(id));
...
function Eyeshadows() {
  ...
  const brands = ["ColorPop", "LuxeBeauty", "GlamVibe"];
  const priceRanges = [
  ...
  const eyeshadowCategories = ["Matte", "Shimmer", "Satin", "Glitter"];
  const eyeshadowFinishes = ["Matte", "Shimmer", "Satin", "Glitter"];
  const sortOptions = [
      ...
      .filter((product) => {
        ...
        const matchesCategory =
          selectedCategory === "all"
            ? true
            : eyeshadowCategories.includes(selectedCategory)
            ? product.category === selectedCategory
            : eyeshadowFinishes.includes(selectedCategory)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      <EyeshadowHeader setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
            ...
            <div className="flex-grow pt-20">
              <div className="max-w-screen-xl mx-auto px-4 py-4 pb-16 relative">
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  / <span className="font-semibold">Eyeshadows</span> - {filteredAndSortedItems.length} Items
                </div>

                <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
                  <h2 className="text-xl font-bold text-gray-800 sm:text-sm">Women's Eyeshadows ({filteredAndSortedItems.length} Items)</h2>
                ...
                <main className="flex-grow">
                  ...
                  {filteredAndSortedItems.length === 0 && (
                    <p className="text-center text-gray-600 mt-8 text-sm">No eyeshadows found matching your criteria.</p>
                  )}
                </main>
              </div>
            </div>
