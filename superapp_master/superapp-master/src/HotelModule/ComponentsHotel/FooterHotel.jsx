...
import { User, Home, Heart, Calendar    } from "lucide-react";
...
function FooterHotel() {
    ...
    const navItems = [
        { id: "/home-hotel", icon: Home, label: "Home" },
        { id: "", icon: Calendar, label: "Bookings" },
        { id: "/home-hotel/favourite", icon: Heart , label: "Favourite" },
