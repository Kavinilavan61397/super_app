...
const foundationProducts = [
  {
    ...
    originalPrice: 850,
    discountedPrice: 680,
    description: 'High-coverage foundation with a natural finish.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Lakmé',
    ...
    offers: [
      { code: 'FOUND5', description: '₹5 off on first order', discount: 5 },
  ...
  {
    id: 3,
    name: 'Pure Natural Foundation',
    originalPrice: 750,
    discountedPrice: 600,
    description: 'Lightweight foundation with herbal extracts.',
    rating: 4.4,
    isBestSeller: false,
    brand: 'Himalaya',
  ...
  {
    id: 4,
    name: '9 to 5 Primer + Foundation',
    originalPrice: 950,
    discountedPrice: 760,
    description: 'Foundation with built-in primer for all-day wear.',
    rating: 4.7,
    isBestSeller: true,
    brand: 'Lakmé',
    category: 'Liquid Foundation',
  ...
  {
    id: 5,
    name: 'Eco Stay Foundation',
    originalPrice: 800,
    discountedPrice: 640,
    description: 'Natural finish foundation with SPF 20.',
    rating: 4.3,
    isBestSeller: false,
    brand: 'Lotus Herbals',
    category: 'Liquid Foundation',
  ...
  {
    id: 6,
    name: 'Glow Cream Foundation',
    originalPrice: 1000,
    discountedPrice: 800,
    description: 'Dewy finish cream foundation for radiant skin.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Himalaya',
    category: 'Cream Foundation',
  ...
  {
    id: 7,
    name: 'Invisible Fluid Foundation',
    originalPrice: 1100,
    discountedPrice: 880,
    description: 'Lightweight fluid foundation for a seamless look.',
    rating: 4.6,
    isBestSeller: false,
    brand: 'Lakmé',
  ...
  {
    id: 8,
    name: 'Herbal Blend Foundation',
    originalPrice: 700,
    discountedPrice: 560,
    description: 'Matte foundation with herbal ingredients.',
    rating: 4.4,
    isBestSeller: false,
    brand: 'Himalaya',
  ...
  {
    id: 9,
    name: 'Weightless Matte Foundation',
    originalPrice: 850,
    discountedPrice: 680,
    description: 'Matte foundation for a lightweight feel.',
    rating: 4.5,
    isBestSeller: true,
    brand: 'Lotus Herbals',
    category: 'Matte Foundation',
  ...
  {
    id: 10,
    name: 'Perfect Radiance Foundation',
    originalPrice: 1200,
    discountedPrice: 960,
    description: 'Radiant finish foundation for glowing skin.',
    rating: 4.7,
    isBestSeller: true,
    brand: 'Lakmé',
    category: 'Cream Foundation',
...
const FoundationHeader = ({ setSelectedCategory, selectedCategory }) => {
  const [isFoundationSubmenuOpen, setIsFoundationSubmenuOpen] = useState(false);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const foundationCategories = [
    { name: 'All', value: 'all' },
    { name: 'Liquid Foundation', value: 'Liquid Foundation' },
    { name: 'Cream Foundation', value: 'Cream Foundation' },
    { name: 'Fluid Foundation', value: 'Fluid Foundation' },
    { name: 'Matte Foundation', value: 'Matte Foundation' },
  ];
  ...
  const toggleFoundationSubmenu = () => {
    setIsFoundationSubmenuOpen((prev) => !prev);
  };
  ...
  const handleCategoryClick = (category) => {
    ...
    setIsFoundationSubmenuOpen(false);
          ...
          <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full">
            {foundationCategories.map((category) => (
              <li key={category.value} className="relative">
                {category.name === 'Liquid Foundation' ? (
                  <>
                    <button
                      className={`text-sm px-3 py-1 rounded-md ${
                        selectedCategory === category.value || foundationShades.includes(selectedCategory)
                          ? 'bg-white text-black'
                          : 'bg-black text-white hover:bg-gray-700'
                      }`}
                      onClick={toggleFoundationSubmenu}
                      aria-label={`Toggle ${category.name} submenu`}
                    >
                      {category.name}
                      <svg
                        className={`inline-block ml-1 w-4 h-4 transform ${isFoundationSubmenuOpen ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
...
const ProductDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const product = foundationProducts.find((p) => p.id === parseInt(id));
...
function Foundations() {
  ...
  const brands = ['Lakmé', 'Lotus Herbals', 'Himalaya'];
  const priceRanges = [
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      <FoundationHeader setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
            ...
            <div className="flex-grow pt-20">
              <div className="max-w-screen-xl mx-auto px-4 py-4 pb-16 relative">
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  <span className="font-semibold">Foundations</span> - {filteredAndSortedItems.length} Items
                </div>

                <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
                  <h2 className="text-xl font-bold text-gray-800 sm:text-sm">Foundations ({filteredAndSortedItems.length} Items)</h2>
                ...
                <main className="flex-grow">
                  ...
                  {filteredAndSortedItems.length === 0 && (
                    <p className="text-center text-gray-600 mt-8 text-sm">No foundations found matching your criteria.</p>
                  )}
                </main>
              </div>
            </div>
