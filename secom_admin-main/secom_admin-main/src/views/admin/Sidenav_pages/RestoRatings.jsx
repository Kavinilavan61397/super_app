...
function RestoRatings() {
    ...
    const fetchRatingData = async () => {
        try {
            const response = await axios.get('https://yrpitsolutions.com/ecom_backend/api/admin/get_all_restaurant_rating');
    ...
    const handleFormUpdate = async (data) => {
        ...
        formData.append('user_id', data.user_id.trim() || selectedRating.user.name);
        ...
        formData.append('restaurant_product_variation_id', data.restaurant_product_variation_id.toString() || selectedRating.restaurant_product_variation_id.toString());

        try {
            const accessToken = localStorage.getItem('OnlineShop-accessToken');
            const url = `https://yrpitsolutions.com/ecom_backend/api/admin/update_restaurant_rating_by_id/${selectedRating.id}`;
    ...
    const handleEditRow = (Rating) => {
        ...
        setValue('user_id', Rating.user ? Rating.user_id : '');  // Set the user name if available
        setValue('comment', Rating.comment);  // Set the comment
        setValue('restaurant_product_variation_id', Rating.restaurant_product_variation_id);
