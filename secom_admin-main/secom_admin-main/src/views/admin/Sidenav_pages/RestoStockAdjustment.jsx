...
function RestoStockAdjustment() {
    ...
    const fetchStockData = async () => { 
        try {
            ...
            const dataArray = Object.values(dataObject); // 🔁 Convert to array
    ...
    const handleEditRow = (brand) => {
        ...
        setValue('product_variation_name', brand.product_variation_name);
    };
                            ...
                            {filteredData.length > 0 ? (
                                getPaginatedData().map((stock) => (
                                    <tr key={stock.id} className="border-t">
                                        ...
                                        <td className="px-6 py-4">{stock.product_variation_name}</td>
                                        <td className="px-6 py-4">{stock.product_variation_quantity}</td>
                                                ...
                                                >
                                                    <div
                                                        onClick={() => {
                                                            handleEditRow(stock);
                                                            setOpenDropdown(null);
                                                            navigate(`/admin/restostocks?product_variation_id=${stock.id}`); // Redirect to the stocks page
                                                        }}
...
export default RestoStockAdjustment;
