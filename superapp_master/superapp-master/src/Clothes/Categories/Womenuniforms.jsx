...
// Sample data for women’s blazers with discount and rating
const womenUniforms = [
...
function WomenUniforms() {
  return (
    <div>
      <EcommerceGroceryHeader />
      <div className="pt-24 px-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-[#000000]">Women Uniforms</h1>
          <Link to="/" className="text-sm text-[#00BB1C] hover:underline">
            Back to Categories
          </Link>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-4">
          {womenUniforms.map((uniform) => (
