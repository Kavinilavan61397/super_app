...
// Women's T-Shirts product data with sub-categories
const womensTShirtItems = [
  {
    id: 1,
    ...
    description: 'Classic crew neck t-shirt, perfect for casual everyday wear.',
    rating: 4.7,
    isBestSeller: true,
    quantity: 1,
  ...
  {
    id: 2,
    name: 'V-Neck Graphic T-Shirt',
    originalPrice: 1400,
    discountedPrice: 1120,
    image: 'https://via.placeholder.com/400',
    description: 'Stylish v-neck t-shirt with bold graphic print, ideal for a trendy look.',
    rating: 4.5,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
  ...
  {
    id: 4,
    name: 'Fitted Performance T-Shirt',
    originalPrice: 1800,
    discountedPrice: 1440,
    image: 'https://via.placeholder.com/400',
    description: 'Breathable performance t-shirt, perfect for workouts or active days.',
    rating: 4.8,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
  ...
  {
    id: 5,
    name: 'Longline Striped T-Shirt',
    originalPrice: 1500,
    discountedPrice: 1200,
    image: 'https://via.placeholder.com/400',
    description: 'Chic longline t-shirt with classic stripes, ideal for casual chic styling.',
    rating: 4.4,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400',
    description: 'Soft scoop neck t-shirt, perfect for a relaxed yet stylish look.',
    rating: 4.7,
    isBestSeller: true,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400',
    description: 'Casual t-shirt with subtle embroidered logo, great for everyday wear.',
    rating: 4.5,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
  ...
  {
    id: 8,
    name: 'Tie-Dye Relaxed T-Shirt',
    originalPrice: 1900,
    discountedPrice: 1520,
    image: 'https://via.placeholder.com/400',
    description: 'Trendy tie-dye t-shirt with a relaxed fit, perfect for a boho vibe.',
    rating: 4.6,
    isBestSeller: false,
    quantity: 1,
    category: "Women's Wear - T-Shirts",
...
const ProductCard = ({ item, onQuickView, addToCart, addToWishlist, cartItems, wishlistItems }) => {
  const { name, originalPrice, discountedPrice, image, description, brand, sizes, fabrics } = item;
  ...
  return (
    <div className="group bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div className="p-3 flex flex-col flex-grow">
        ...
        <p className="text-xs text-gray-600 mb-2">Fabric: {fabrics.join(', ')}</p>
...
function WomensTShirts() {
  ...
  const allAvailableSizes = ['XS', 'S', 'M', 'L', 'XL'];
  const brands = [...new Set(womensTShirtItems.map((item) => item.brand))];
  const allAvailableFabrics = [...new Set(womensTShirtItems.flatMap((item) => item.fabrics))];
  const allAvailableCategories = [...new Set(womensTShirtItems.map((item) => item.subCategory))];
  ...
  const handleFilterChange = (key, value) => {
    setFilterState((prev) => {
      ...
      if (['discount', 'brands', 'sizes', 'fabrics', 'categories'].includes(key)) {
    ...
    return womensTShirtItems
      .filter((item) => {
        ...
        const matchesCategory = filterState.categories.length
          ...
          : true;
        return matchesDiscount && matchesBrands && matchesPrice && matchesBestSeller && matchesSize && matchesFabric && matchesCategory;
      })
      .sort((a, b) => {
      ...
      <div className="flex-grow pt-16">
        <div className="max-w-screen-xl mx-auto px-4 py-4 pb-12">
          ...
          <div className="text-xs text-gray-600 mb-4">
            ...
            / <span className="font-semibold">T-Shirts</span> - {filteredAndSortedItems.length} Items
          </div>

          {/* Filter and Sort Controls */}
          <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:justify-between sm:items-center gap-2 mb-4">
            <h2 className="text-lg font-bold text-gray-800 sm:text-sm">Women's T-Shirts ({filteredAndSortedItems.length})</h2>
      ...
      {quickView && (
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-2">Fabric: {quickView.fabrics.join(', ')}</p>
            ...
            <button
              ...
              onClick={() => {
                if (!quickViewSize && quickView.sizes && quickView.sizes.length > 0) {
                  alert('Please select a size.');
                  return;
                }
