    ...
    useEffect(() => {
        async function fetchData() {
            ...
            try {
                ...
                // Filter for 'Kitchen Appliances' subcategory
                const filtered = (data.data || data).filter(
                  p => (p.category === 'Kitchen Appliances' || p.category_name === 'Kitchen Appliances' || (p.category && p.category.name === 'Kitchen Appliances'))
                );
