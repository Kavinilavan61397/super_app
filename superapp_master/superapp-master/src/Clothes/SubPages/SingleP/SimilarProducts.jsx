...
const SimilarProducts = ({ product }) => {
    ...
    return (
        <div className="relative bg-white p-2 rounded-2xl border border-gray-300 shadow-md flex flex-col mx-2">
            {/* Like Button */}
            ...
            {/* Product Image */}
            <div
                onClick={() => navigate(`/home-clothes/single-product-page`)}
                className=" relative w-[120px] h-[110px] mx-auto pt-2 flex items-center justify-center overflow-hidden rounded-md cursor-pointer"
            >
