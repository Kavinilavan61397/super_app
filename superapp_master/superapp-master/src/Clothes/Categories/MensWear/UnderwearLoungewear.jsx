  ...
  return (
    <div className="group bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <p className="text-sm text-gray-600 mb-2">Underwear & Loungewear</p>
      ...
      <div className="flex-grow pt-20">
        <div className="max-w-screen-xl mx-auto px-4 py-4 pb-32">
          ...
          <div className="text-sm text-gray-600 mb-4">
            <Link to="/home-clothes" className="hover:underline">Home</Link> / <Link to="/home-clothes/categories" className="hover:underline">Categories</Link> / <Link to="/categories/mens-wear" className="hover:underline">Men's Wear</Link> / <span className="font-semibold">Underwear & Loungewear</span> - {filteredAndSortedItems.length} Items
          </div>

          {/* Title Section */}
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Men's Underwear & Loungewear Collection</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Experience ultimate comfort with our premium collection of men's underwear and loungewear. 
              From everyday essentials to cozy home wear, find your perfect comfort zone.
            </p>
          </div>
            ...
            {/* Dropdown Filter Panel */}
              ...
              >
                ...
                <div className="mb-2 sm:mb-6">
                    <input
                      type="text"
                    placeholder="Search Underwear & Loungewear"
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 mb-2">Underwear & Loungewear</p>
...
export default UnderwearLoungewear;